...
class PinryRuleSetProviderTest {
     ...
     * qualified name, calls `io.ebean.DB`, or merges a row outside its transaction unsuppressed, so
     * each reports nothing whether it is registered or absent from the
